#!/usr/bin/env python3
"""Run OB and Fractal strategies for TSLS and save results to cache"""
import json
import os
import sys

# Ensure repo root is on module search path so sibling modules can be imported
...
def load_market_data(symbol: str, data_type: str = 'stocks'):
    try:
...
def save_strategy_result(strategy_name: str, symbol: str, result: dict, data_type: str = 'stocks'):
